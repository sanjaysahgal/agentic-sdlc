...
3. The AI Product Manager will greet you in the channel automatically.
4. Start describing the feature. You don't need to have a full brief ready — start with what you know. The AI Product Manager will ask questions.

## What the conversation looks like

The AI Product Manager's job is to help you think through the feature completely before anyone builds anything. It will:
...
You don't need to answer everything in one session. Come back the next day — the AI Product Manager picks up exactly where you left off. Your work is saved automatically after every conversation.
...
The AI Product Manager will guide you through all of this, but a complete spec answers:
...
Some questions need a designer to answer (what does the screen look like, what does the interaction feel like). Some need an engineer (is this technically feasible, how long will it take). When the AI Product Manager surfaces open questions, it will tell you which kind each one is — so you know who to follow up with.
